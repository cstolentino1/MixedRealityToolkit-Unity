...
struct AkArrayAllocatorNoAlign
{
	...
	static  void TransferMem(void *& io_pDest, AkArrayAllocatorNoAlign<T_MEMID>, void * in_pSrc )
	{
		io_pDest = in_pSrc;
	}
};
...
struct AkArrayAllocatorAlignedSimd
{
	 ...
	 void Free( void * in_pAddress )
	{
	 ...
	 void TransferMem(void *& io_pDest, AkArrayAllocatorAlignedSimd<T_MEMID>, void * in_pSrc )
	{
		io_pDest = in_pSrc;
	}
};
